...
public final class MobileProtocol {
  ...
  public enum AddressType
    ...
    public static AddressType valueOf(int value) {
      switch (value) {
        case 1: return SERVICE_ADDRESS;
        case 2: return DEVICE_ADDRESS;
        default: return null;
      }
    }
  ...
  public static final class MobileMessageProtocol extends
    ...
    // optional .ActorInfoProtocol actorInfo = 4;
    public static final int ACTORINFO_FIELD_NUMBER = 4;
    ...
    // optional .UuidProtocol answerFor = 5;
    public static final int ANSWERFOR_FIELD_NUMBER = 5;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000004) == 0x00000004)) {
        output.writeMessage(3, nodeAddress_);
      }
      if (((bitField0_ & 0x00000008) == 0x00000008)) {
        output.writeMessage(4, actorInfo_);
      }
      if (((bitField0_ & 0x00000010) == 0x00000010)) {
        output.writeMessage(5, answerFor_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000004) == 0x00000004)) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, nodeAddress_);
      }
      if (((bitField0_ & 0x00000008) == 0x00000008)) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, actorInfo_);
      }
      if (((bitField0_ & 0x00000010) == 0x00000010)) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, answerFor_);
      }
      if (((bitField0_ & 0x00000020) == 0x00000020)) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(akka.mobile.protocol.MobileProtocol.MobileMessageProtocol other) {
        if (other == akka.mobile.protocol.MobileProtocol.MobileMessageProtocol.getDefaultInstance()) return this;
        if (other.hasUuid()) {
  ...
  public static final class RemoteActorRefProtocol extends
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(akka.mobile.protocol.MobileProtocol.RemoteActorRefProtocol other) {
        if (other == akka.mobile.protocol.MobileProtocol.RemoteActorRefProtocol.getDefaultInstance()) return this;
        if (other.hasUuid()) {
          mergeUuid(other.getUuid());
        }
  ...
  public static final class MetadataEntryProtocol extends
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(akka.mobile.protocol.MobileProtocol.MetadataEntryProtocol other) {
        if (other == akka.mobile.protocol.MobileProtocol.MetadataEntryProtocol.getDefaultInstance()) return this;
        if (other.hasKey()) {
          setKey(other.getKey());
        }
        if (other.hasValue()) {
